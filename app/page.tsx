...
export default function Home() {
  ...
  // 🔥 OTOMATİK YENİ HAKEM KAYDETME ZEKASI 🔥
  ...
  const skorRaporunuGonder = async (macId: number, kayitTuru: 'hizli' | 'detayli') => {
    ...
    if (kayitTuru === 'detayli') { 
        ...
        await yeniHakemleriKaydet(kaydedilecekDetay); // 🔥 GÖNDERİLİRKEN YENİ HAKEMLER VERİTABANINA DÜŞÜYOR
    } 
              ...
              <div className="border-[3px] border-double border-slate-600 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-0 border border-black mb-6 text-black">
                      ...
                      <div className="border-r border-black flex flex-col">
                          {/* 🔥 HAKEM BÖLÜMÜ GÜNCELLENDİ: "Listeden Seç veya Yeni İsim Yaz" eklendi 🔥 */}
                      ...
                      <div className="flex flex-col">
                          {/* AMATÖRDE SADECE VAR/YOK KALIYOR (Ekmel Kanunu) */}
  ...
  // 🔥 GERİ GETİRİLEN MÜSAİTLİK / MAZERET BİLDİRİMİ SAYFASI 🔥
